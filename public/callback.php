...
$grantCode = isset($_GET['openid.spark.code'])?$_GET['openid.spark.code']:$_GET['code'];
...
echo "<div><h1><a href='http://listingpass.web.mikeamato.org:3000/callback".$urlend.">go Local!</a></h1><br/></div>";
?>
</body></html>
